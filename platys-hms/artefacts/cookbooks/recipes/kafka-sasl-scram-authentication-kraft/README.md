...
Navigate to AKHQ on <http://10.156.72.248:28107>.

## KaDeck

Navigate to KaDeck on <http://10.156.72.248:28313>, login as user `admin` with password `admin` and accept the license information.
