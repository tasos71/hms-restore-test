...
Navigate to the NiFi Registry: <http://10.156.72.248:19090/nifi-registry> and create a new bucket and name it `my-bucket`.

![](./images/create-bucket.png)

Navigate to NiFi <https://10.156.72.248:18080> and login as user `nifi` with password `1234567890ACD`.
